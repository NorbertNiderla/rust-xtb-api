...
use rust_xtb_api::{ChartLastData, XtbCommand, XtbConnection, XtbGetChartLastRequestCommand, XtbLoginCommand, XtbLogoutCommand, XtbOutput, XtbPeriod};
use async_std;
...
async fn test_getting_last_chart() {
    ...
    let request_response = xtb.issue_command(&XtbCommand::GetChartLastRequest(XtbGetChartLastRequestCommand::new(
        "B24.PL",
        XtbPeriod::D1,
